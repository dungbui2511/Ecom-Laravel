                        ...
                        <li class="product-item">
                            <div class="product product-widget-style">
                                <div class="thumbnnail">
                                    <a href="{{route('product.details',['slug'=>$p_product->slug])}}" title="{{$p_product}}">
                    ...
                    <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                       ...
                       <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="{{route('product.details',['slug'=>$r_pro->slug])}}" title="{{$r_pro->name}}">
                                    <figure><img src="{{asset('assets/images/products/'.$r_pro->image)}}" width="214" height="214" alt="{{$r_pro->name}}"></figure>
                                </a>
                            ...
                            <div class="product-info">
                                <a href="#" class="product-name"><span>{{$r_pro->name}}</span></a>
                                <div class="wrap-price"><span class="product-price">${{$r_pro->regular_price}}</span></div>
                            </div>
                        </div>
                       @endforeach
