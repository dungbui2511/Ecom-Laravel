        ...
        <div class="row">
            ...
            <div class="billing-address">
                ...
                <!-- <p class="row-in-form">
                    ...
                    <input type="text" name="add" value="" placeholder="Street at apartment number" wire:model="mobile">
                </p> -->
                <p class="row-in-form">
                    <label for="add">Line1:</label>
                    <input type="text" name="line1" value="" placeholder="United States" wire:model="line1">
                    @error('line1') <span class="text-danger">{{$message}}</span> @enderror
                </p>
                <p class="row-in-form">
                    <label for="add">Line2:</label>
                    <input type="text" name="line2" value="" placeholder="United States" wire:model="line2">
